...
x=dataset.iloc[0:100,0].values  #string review text in x
y=dataset.iloc[0:100,1].values  #string review class in y
...
for character in range(0, len(x)):    
    ...
    review = review.split()
    """extracting the root words and removing the stop words from the word 
    in the review
    """
    ps = PorterStemmer()
